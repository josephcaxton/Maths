...
@synthesize AnswerObjects,CorrectAnswers,MultichoiceAnswers,SelectedAnswers,AnswerCounter,ShowAnswer,HighlightedAnswers,Continue;
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    headerView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 80, 45)];
